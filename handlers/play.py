...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>❰𝑴𝒖𝒔𝒊𝒄𝑭 ❘ 𝑭𝒓𝒊𝒆𝒏𝒅𝒔🚩❱ 𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁 𝗨𝘀𝗲𝗿𝗕𝗼𝘁 𝗜𝘀 𝗡𝗼𝘁 𝗜𝗻 𝗧𝗵𝗶𝘀 𝗖𝗵𝗮𝘁' 𝗔𝘀𝗸 𝗔𝗱𝗺𝗶𝗻 𝗧𝗼 𝗦𝗲𝗻𝗱 /𝗽𝗹𝗮𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 𝗙𝗼𝗿 𝗙𝗶𝗿𝘀𝘁 𝗧𝗶𝗺𝗲 𝗧𝗼 𝗔𝗱𝗱 𝗜𝘁 😎🤟</i>")
        return
    ...
    if audio:
        ...
        await lel.edit("🔎 **𝗙𝗶𝗻𝗱𝗶𝗻𝗴 💫 𝗧𝗵𝗲 𝗦𝗼𝗻𝗴 ❤️ ❰𝑭𝒓𝒊𝒆𝒏𝒅𝒔 🚬❱...**")
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption="**❰ 𝑴𝒖𝒔𝒊𝒄𝑭 ❘ 𝑭𝒓𝒊𝒆𝒏𝒅𝒔 🚩❱ 𝗦𝗼𝗻𝗴 ❤️ 𝗣𝗼𝘀𝗶𝘁𝗶𝗼𝗻 💫🤟** {}".format(
        position
        ),
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="**❰𝑴𝒖𝒔𝒊𝒄𝑭 ❘ 𝑭𝒓𝒊𝒆𝒏𝒅𝒔🚩❱ Now 😄 𝗣𝗹𝗮𝘆𝗶𝗻𝗴 📀 𝗔𝘁 🤟 `{}`...**".format(
        message.chat.title
        ), )
        os.remove("final.png")
        return await lel.delete()
